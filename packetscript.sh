...
packet_config=$config_files/inducts/bpgen_one_stcp_port4560.json
...
./build/common/bpcodec/apps/bpsendpacket --use-bp-version-7 --my-uri-eid=ipn:1.1 --dest-uri-eid=ipn:2.1 --outducts-config-file=$gen_config --packet-inducts-config-file=$packet_config &
bpgen_PID=$!
sleep 8
