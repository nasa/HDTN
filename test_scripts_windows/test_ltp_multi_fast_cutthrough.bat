...
timeout /t 3
START "Egress" /D "%HDTN_BUILD_ROOT%" "cmd /k" "%HDTN_BUILD_ROOT%\module\egress\hdtn-egress-async.exe" "--outducts-config-file=%HDTN_SOURCE_ROOT%\tests\config_files\outducts\egress_two_ltp_port4557flowid1_port4558flowid2.json"
timeout /t 3
