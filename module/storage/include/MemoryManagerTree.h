...
private:
    STORAGE_LIB_EXPORT void SetupTree(const int depth, void *node);
    STORAGE_LIB_EXPORT void FreeTree(const int depth, void *node);
    STORAGE_LIB_EXPORT void GetAndSetFirstFreeSegmentId(const int depth, void *node, boost::uint32_t * segmentId);
    STORAGE_LIB_EXPORT void FreeSegmentId(const int depth, void *node, boost::uint32_t segmentId, bool *success);
