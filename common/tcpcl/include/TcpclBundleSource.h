...
public:
    ...
    TCPCL_LIB_EXPORT ~TcpclBundleSource();
...
private:
    ...
    TCPCL_LIB_EXPORT void StartTcpReceive();
    TCPCL_LIB_EXPORT void HandleTcpReceiveSome(const boost::system::error_code & error, std::size_t bytesTransferred);
