...
BOOST_AUTO_TEST_CASE(LtpEngineTestCase, *boost::unit_test::enabled())
{
    struct Test {
        ...
        Test() :
            ...
            engineSrc(ENGINE_ID_SRC, 1, 1, UINT64_MAX, ONE_WAY_LIGHT_TIME, ONE_WAY_MARGIN_TIME, 0, 50, false, 0, 5, false, 0, 100, 0, 1, 0),//1=> 1 CHARACTER AT A TIME, UINT64_MAX=> unlimited report segment size
            engineDest(ENGINE_ID_DEST, 1, 1, UINT64_MAX, ONE_WAY_LIGHT_TIME, ONE_WAY_MARGIN_TIME, 0, 50, false, 0, 5, false, 0, 100, 1000, 1, 0),//1=> MTU NOT USED AT THIS TIME, UINT64_MAX=> unlimited report segment size
