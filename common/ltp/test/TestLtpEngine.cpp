...
BOOST_AUTO_TEST_CASE(LtpEngineTestCase, *boost::unit_test::enabled())
{
    ...
    ltpRxCfg.newFileDurationMsToStoreSessionDataOrZeroToDisable = 0; //unused for inducts (must be set to 0) //must be 0 for this test
    ltpRxCfg.writeSessionDataToFilesPath = "./"; //unused for inducts
    ...
    ltpTxCfg.newFileDurationMsToStoreSessionDataOrZeroToDisable = 0; //must be 0 for this test
