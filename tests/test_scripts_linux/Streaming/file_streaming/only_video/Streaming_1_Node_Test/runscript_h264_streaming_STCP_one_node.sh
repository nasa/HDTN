...
gst-launch-1.0 -e filesrc location=$VIDEO_TO_STREAM_FILEPATH ! qtdemux ! h264parse ! rtph264pay config-interval=1 ! udpsink host=127.0.0.1 port=$incoming_rtp_port &
