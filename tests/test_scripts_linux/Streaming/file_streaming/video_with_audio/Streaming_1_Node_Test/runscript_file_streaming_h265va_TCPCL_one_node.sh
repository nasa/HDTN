...
gst-launch-1.0 -e udpsrc address=127.0.0.1 port=8900 ! "application/x-rtp, media=(string)video, clock-rate=(int)90000, encoding-name=(string)MP2T, payload=(int)96" \
        ! rtpmp2tdepay ! queue ! tsparse ! filesink location=received.ts &
