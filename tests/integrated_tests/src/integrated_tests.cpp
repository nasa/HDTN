...
BOOST_AUTO_TEST_CASE(it_TestHDTNStorageModeTCPCLv7, * boost::unit_test::enabled()) {
    std::cout << std::endl << ">>>>>> Running: " << "it_TestHDTNStorageModeTCPCL for version 7" << std::endl << std::flush;
    bool result = TestHDTNStorageModeTCPCL();
    BOOST_CHECK(result == true);
}
*/
