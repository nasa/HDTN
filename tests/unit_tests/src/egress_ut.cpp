...
TEST_F(HegrUdpEntryFixture, InitTestNominal1) {
    ...
    EXPECT_EQ(saddr.sin_family, this->m_ipv4.sin_family)
        << "Problem HegrUdpEntryFixture, InitTestNominal1, comparison with "
           "sin_family";
    EXPECT_EQ(saddr.sin_port, this->m_ipv4.sin_port) << "Problem HegrUdpEntryFixture, InitTestNominal1, comparison with "
                                                       "sin_port";
    EXPECT_EQ(saddr.sin_addr.s_addr, this->m_ipv4.sin_addr.s_addr)
        << "Problem HegrUdpEntryFixture, InitTestNominal1, comparison with "
           "sin_addr.s_addr";
}
...
TEST_F(HegrUdpEntryFixture, EnableTestNominal1) {
    ...
    EXPECT_EQ(HEGR_FLAG_UP, this->m_flags & HEGR_FLAG_UP)
...
TEST_F(HegrUdpEntryFixture, DisableTestNominal1) {
    ...
    EXPECT_NE(HEGR_FLAG_UP, this->m_flags & HEGR_FLAG_UP)
