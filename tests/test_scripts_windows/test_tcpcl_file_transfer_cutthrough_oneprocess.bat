...
<<<<<<< HEAD:tests/test_scripts_windows/test_tcpcl_file_transfer_cutthrough_oneprocess.bat
START "BpReceiveFile" /D "C:/hdtn_tmp" "cmd /k" "%HDTN_BUILD_ROOT%\common\bpcodec\apps\bpreceivefile.exe" "--save-directory=.\received" "--my-uri-eid=ipn:2.1" "--inducts-config-file=%HDTN_SOURCE_ROOT%\config_files\inducts\bpsink_one_tcpcl_port4558.json"
=======
...
>>>>>>> master:test_scripts_windows/test_tcpcl_file_transfer_cutthrough_oneprocess.bat
timeout /t 3
...
START "BpSendFile" /D "C:/hdtn_tmp" "cmd /k" "%HDTN_BUILD_ROOT%\common\bpcodec\apps\bpsendfile.exe" "--max-bundle-size-bytes=4000000" "--file-or-folder-path=." "--my-uri-eid=ipn:1.1" "--dest-uri-eid=ipn:2.1" "--outducts-config-file=%HDTN_SOURCE_ROOT%\config_files\outducts\bpgen_one_tcpcl_port4556.json"
